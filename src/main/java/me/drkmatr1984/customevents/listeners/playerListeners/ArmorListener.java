...
import me.drkmatr1984.customevents.enums.ArmorType;
import me.drkmatr1984.customevents.playerEvents.ArmorEquipEvent;
import me.drkmatr1984.customevents.playerEvents.ArmorEquipEvent.EquipMethod;
...
public class ArmorListener implements Listener{
	...
	public final void onInventoryClick(final InventoryClickEvent e){
		...
		if(shift){
			...
			if(numberkey){
				if(e.getClickedInventory().getType().equals(InventoryType.PLAYER)){// Prevents the 2by2 crafting
