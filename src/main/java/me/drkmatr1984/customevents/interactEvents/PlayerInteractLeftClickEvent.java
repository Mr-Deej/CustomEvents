...
public class PlayerInteractLeftClickEvent extends PlayerInteractBaseClickEvent{
	...
	public PlayerInteractLeftClickEvent(Plugin plugin, Player player, Block clickedBlock, BlockFace blockFace, ItemStack itemStack, Material material, boolean cancelled, Action action){
		this.plugin = plugin;
		this.player = player;
